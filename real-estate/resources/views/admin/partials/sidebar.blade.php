...
<div id="sidebar" class="hidden md:block w-64 bg-white shadow-lg fixed top-0 left-0 h-full z-50 overflow-y-auto" style="scrollbar-width: thin; scrollbar-color: #c1c1c1 #f1f1f1;">
    ...
    <!-- Navigation Menu -->
    <div class="py-4">
        <h3 class="px-4 text-xs font-medium text-gray-500 uppercase tracking-wider mb-3" style="letter-spacing: 0.05em;">Admin Dashboard</h3>
        <nav>
            <ul>
                <li>
...
<!-- Bookings Link -->
                <li>
                    <a href="{{ route('admin.bookings') }}"
                        ...
                        <span style="font-weight: 500;">Bookings</span>
                    </a>
                </li>
                <!-- Messages Link -->
                <li>
...
<!-- Reviews Link -->
                <li>
                    <a href="{{ route('admin.reviews') }}"
                        ...
                        <span style="font-weight: 500;">Reviews</span>
                    </a>
                </li>
                <!-- Settings Link -->
                <li>

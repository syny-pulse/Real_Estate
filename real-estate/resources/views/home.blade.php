...
@section('content')
    ...
    <section class="hero-section h-96 flex items-center"
        style="background-image: url('/uploads/properties/hero.jpg'); background-size: 100% auto; background-repeat: no-repeat; background-position: center;">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-6">Find Your Perfect Home</h1>
            <p class="text-xl text-white mb-8 max-w-2xl mx-auto">Browse thousands of properties across the country and find
                the perfect place for you and your family.</p>
                ...
                @forelse ($featuredProperties as $property)
                    ...
                    <div class="property-card bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="h-48 bg-gray-200">
                            ...
                            @else
                                <img src="\uploads\properties\default-property.jpg" alt="{{ $property->title }}"
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{ route('properties.show', $property->id) }}"
                                class="block mt-4 text-center py-2 border border-blue-800 text-blue-800 rounded hover:bg-blue-800 hover:text-white transition">View
                                Details</a>
                        </div>
                    </div>
                @empty
    ...
    <section class="py-16 bg-blue-800 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 max-w-2xl mx-auto">Join thousands of happy customers who found their perfect home with
                PropertyFinder.</p>
            <div class="space-x-4">

    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function reverseGeocode(lat, lng) {
                ...
                fetch(`https://nominatim.openstreetmap.org/reverse?lat=${lat}&lon=${lng}&format=json`, {
                    ...
                    .then(data => {
                        ...
                        let locationName = address?.city || address?.town || address?.village || address
                            ?.suburb || address?.hamlet || "Unknown location";
                ...
                mutations.forEach((mutation) => {
                    if (mutation.addedNodes.length) {
                        ...
                        const resultsElements = document.querySelectorAll(
                            '.leaflet-control-geocoder-results, .leaflet-control-geocoder-results *, .leaflet-control-geocoder-alternatives li'
                        );
            ...
            setTimeout(() => {
                ...
                const resultsElements = document.querySelectorAll(
                    '.leaflet-control-geocoder-results, .leaflet-control-geocoder-results *');
                resultsElements.forEach(el => {
                    el.style.backgroundColor = 'white';
                });

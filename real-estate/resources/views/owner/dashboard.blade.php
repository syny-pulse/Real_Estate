            ...
            <div class="flex items-center space-x-6">
                @guest
                    <div class="flex space-x-3">
                        <a href="{{ route('login') }}" class="px-4 py-2 border border-white text-white rounded-md hover:bg-white hover:text-blue-800 transition">Log In</a>
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-white text-blue-800 rounded-md hover:bg-blue-100 transition">Sign Up</a>
                    </div>
                @else
                    <div class="relative group">
                        <button class="flex items-center space-x-2 text-white focus:outline-none">
                            <div class="h-10 w-10 rounded-full overflow-hidden border-2 border-white">
                                @if(Auth::user()->profile_image)
                                    <img src="{{ Auth::user()->profile_image }}" alt="{{ Auth::user()->name }}" class="h-full w-full object-cover">
                                @else
                                    <div class="h-full w-full bg-blue-600 flex items-center justify-center text-white text-lg font-bold">
                        ...
                        <div class="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 hidden group-hover:block">
                            <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">Dashboard</a>
                            <a href="/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">Profile Settings</a>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50">
                                Logout
                            </a>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between">
            ...
            <div class="flex items-center mb-4 sm:mb-0">
                <div class="relative h-16 w-16 rounded-full overflow-hidden border-2 border-blue-800 mr-4 group">
                    ...
                    @else
                        <div class="w-full h-full bg-blue-800 flex items-center justify-center text-white text-xl font-bold">
                            {{ substr(Auth::user()->name, 0, 1) }}
                        </div>
                    @endif
                    
                    <!-- Edit Profile Image Overlay -->
                    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer" onclick="document.getElementById('profile-image-upload').click()">
                    ...
                    <form id="profile-image-form" action="{{ route('profile.update-image') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="file" id="profile-image-upload" name="profile_image" class="hidden" onchange="document.getElementById('profile-image-form').submit()">
                    </form>
                </div>
                <div>
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <div class="bg-gray-50 rounded-lg px-4 py-3 text-center">
                    ...
                    <div class="flex items-center justify-center text-yellow-400">
                        <span class="text-lg font-semibold text-gray-800 mr-1">{{ number_format(Auth::user()->average_rating ?? 0, 1) }}</span>
            ...
            <div class="lg:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <nav>
                        <ul class="space-y-2">
                            <li>
                                <a href="#properties" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                            ...
                            <li class="relative group">
                                <button class="flex items-center justify-between w-full p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                ...
                                <div class="pl-8 mt-2 space-y-2 hidden group-hover:block">
                                    <a href="#active-bookings" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Active Bookings
                                    </a>
                                    <a href="#pending-requests" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Pending Requests
                                    </a>
                                    <a href="#booking-history" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Booking History
                                    </a>
                                </div>
                            </li>
                            <li>
                                <a href="#messages" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <li class="relative group">
                                ...
                                <div class="pl-8 mt-2 space-y-2 hidden group-hover:block">
                                    <a href="#earnings" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Earnings Summary
                                    </a>
                                    <a href="#transactions" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Transactions
                                    </a>
                                    <a href="#withdrawals" class="block p-2 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                        Withdrawals
                                    </a>
                                </div>
                            </li>
                            <li>
                                <a href="#reviews" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-.38 1.81.588 1.81h4.914a1 1 0 00.951-.69l1.519-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                    </svg>
                                    Ratings & Reviews
                                </a>
                            </li>
                            <li>
                                <a href="#settings" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-800 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mt-6">
                    ...
                    <div class="space-y-4">
                        <a href="/properties/create" class="block w-full py-3 px-4 bg-blue-800 text-white rounded-md text-center hover:bg-blue-900 transition">
                            Add New Property
                        </a>
                        <a href="/withdraw" class="block w-full py-3 px-4 border border-blue-800 text-blue-800 rounded-md text-center hover:bg-blue-50 transition">
                            Request Withdrawal
                        </a>
                    </div>
                </div>
            ...
            <div class="lg:w-3/4">
                ...
                <div id="properties" class="bg-white rounded-lg shadow-md p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="/properties/create" class="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-900 transition">Add New Property</a>
                    </div>
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-4 flex space-x-2">
                                            <a href="{{ route('properties.edit', $property->id) }}" class="px-3 py-1 border border-blue-800 text-blue-800 rounded hover:bg-blue-50 transition text-sm">Edit</a>
                                            <a href="{{ route('properties.show', $property->id) }}" class="px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition text-sm">View</a>
                                            <form action="{{ route('properties.destroy', $property->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="px-3 py-1 border border-red-500 text-red-500 rounded hover:bg-red-50 transition text-sm" onclick="return confirm('Are you sure you want to delete this property?')">Delete</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @foreach($upcomingBookings as $booking)
                                    <div class="flex py-2 border-b border-gray-100">
                                        <div class="flex-shrink-0 mr-3">
                                            <div class="h-12 w-12 rounded-lg bg-blue-50 flex items-center justify-center text-blue-800 font-bold">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-600">{{ date('M d', strtotime($booking->start_date)) }} - {{ date('M d, Y', strtotime($booking->end_date)) }}</p>

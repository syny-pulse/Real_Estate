                ...
                <div id="properties" class="bg-white rounded-lg shadow-md p-4 lg:p-6 mb-8">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        ...
                        <a href="{{ route('properties.create') }}"
                            class="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-900 transition w-full sm:w-auto text-center flex items-center justify-center gap-2">
                    ...
                    <div id="tabContent">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div
                                        ...
                                        <div class="relative h-48">
                                            ...
                                            <div class="absolute top-2 right-2">
                                                <span
                                                    class="px-2 py-1 text-xs font-medium rounded-full {{ $property->status == 'approved'
                                        ...
                                        <div class="p-4">
                                            <h4 class="text-lg font-semibold text-gray-800 mb-1 truncate">
                                                {{ $property->title }}</h4>
                                            <p class="text-gray-600 text-sm mb-2 truncate">{{ $property->city }},
                                                {{ $property->address }}</p>
                                            ...
                                            <div class="flex flex-wrap gap-3 mb-4 text-gray-500 text-sm">
                                                ...
                                                @if ($property->bedrooms > 0)
                                                    <div class="flex items-center">
                                                        ...
                                                        {{ $property->bedrooms }}
                                                        {{ Str::plural('Bed', $property->bedrooms) }}
                                                    </div>
                                                @endif
                                                ...
                                                @if ($property->bathrooms > 0)
                                                    <div class="flex items-center">
                                                        ...
                                                        {{ $property->bathrooms }}
                                                        {{ Str::plural('Bath', $property->bathrooms) }}
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="flex space-x-2">
                                                <a href="{{ route('properties.edit', $property->id) }}"
                                                    class="px-3 py-1.5 border border-blue-800 text-blue-800 rounded hover:bg-blue-50 transition text-sm flex-1 text-center">Edit</a>
                                                <button type="button"
                                                    class="px-3 py-1.5 border border-red-500 text-red-500 rounded hover:bg-red-50 transition text-sm flex-shrink-0"
                                ...
                                @empty
                                    <div class="col-span-full flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <a href="{{ route('properties.create') }}"
                                            class="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-blue-900 transition flex items-center gap-2">
                        ...
                        <div class="hidden" id="approved" role="tabpanel" aria-labelledby="approved-tab">
                            <div class="mb-6">
                                <!-- Show the total count card just once -->
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-500">Active Properties</div>
                                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['approved'] }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Then show the list of approved properties -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                @forelse(Auth::user()->properties->where('status', 'approved') as $property)
                                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                                        ...
                                        <div class="flex items-center text-sm text-gray-500">
                                            ...
                                            <span class="ml-2">{{ $property->updated_at->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                @empty
                                    <div class="col-span-full flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <div class="hidden" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                            <div class="mb-6">
                                ...
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-500">Pending Properties</div>
                                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['pending'] }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Then show the list of pending properties -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="hidden" id="rejected" role="tabpanel" aria-labelledby="rejected-tab">
                            <div class="mb-6">
                                ...
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-500">Rejected Properties</div>
                                            <div class="text-2xl font-semibold text-gray-900">{{ $stats['rejected'] }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Then show the list of rejected properties -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div id="deletePropertyModal"
                    ...
                    <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                        ...
                        <p class="text-gray-500 mb-6">Are you sure you want to delete "<span
                                id="propertyTitleToDelete"></span>"? This action cannot be undone.</p>
                        ...
                        <form id="deletePropertyForm" method="POST" class="flex justify-end gap-3">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition">Delete
                                Property</button>
                        </form>
                    </div>
                </div>
                                ...
                                @foreach ($upcomingBookings as $booking)
                                    <div class="flex py-2 border-b border-gray-100">
                                        <div class="flex-shrink-0 mr-3">
                                            <div
                                                class="h-12 w-12 rounded-lg bg-blue-50 flex flex-col items-center justify-center text-blue-800">
                                                <span
                                                    class="font-bold leading-none">{{ date('d', strtotime($booking->start_date)) }}</span>
                                                <span
